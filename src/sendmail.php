...
$message .= '<h1>Акция : '.$data->header.'</h1>';
...
$message .= '<p>Skype : <strong>'.$data->skype.'</strong></p>';
...
$headers .= 'From: MamontovaDesign <callback@md.com>' . "\r\n";
...
echo mail($to, 'Акции MD', $message, $headers);
